...
class QuicClientBase : public QuicClientBaseVisitorInterface 
{
 public:
  ...
  // // [SD] Start Address change
  // void StartAddressChange(QuicIpAddress toip) { 
  //   toip_ = toip;
  //   SetAddressChangeAlarm(); 
  // }
  ...
  //QuicIpAddress ToIp() { return toip_; }
 ...
 protected:
  ...
  // [SD] for AddressChangeDelegate
  //std::unique_ptr<QuicAlarm> address_change_alarm_;

  //void SetAddressChangeAlarm();
 ...
 private:
  ...
  // [SD] store addresses.
  QuicIpAddress fromip_, toip_, current_path_gateway_, current_path_ip_;
};
